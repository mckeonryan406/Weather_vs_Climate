...
currentYear = 2019  # MAKE DYNAMIC IN SHINY
...
### Monthly Temperture and Precipition (Averaged over 1981-2010)  
...
### Daily Temperature Experienced vs. the Average and the Records for each day
...
### Hotness Index - Are the hot days getting hotter?
...
```{r, fig.cap="Monthly temperature anomaly: This bar graph compares the average monthly temperature computed over the full duration of the record with that averaged over just the last ten years (2010-2019)."}
